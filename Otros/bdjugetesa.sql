...
--
-- Estructura de tabla para la tabla `empaquetamiento`
--

CREATE TABLE `empaquetamiento` (
  `Id_Empaque` int(11) NOT NULL,
  `Tipo_Empaque` int(11) NOT NULL,
  `Juguete_Empaque` int(11) NOT NULL,
  `Empleado_Empaque` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

--
-- Volcado de datos para la tabla `empaquetamiento`
--
...
CREATE TABLE `th_produccion_juguetes` (
  ...
  `empleados_Produccion` int(11) DEFAULT NULL,
  `juguetes_Produccion` int(11) DEFAULT NULL,
  ...
  `Material_Utilizado` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `th_produccion_juguetes` (`Id_produccion`, `empleados_Produccion`, `juguetes_Produccion`, `Fecha_produccion`, `Detalles_produccion`, `Errores_produccion`, `Cantidad_producida`, `Material_Utilizado`) VALUES
...
(16, 9, 2, '2025-01-28', 'Falta de tiempo', 1, 5, 10);
...
ALTER TABLE `am_contactos`
  ...
  ADD KEY `FK_am_contactos_ct_catalogo_universal` (`Tipo_contacto`),
  ADD KEY `FK_am_contactos_tb_empleados` (`Id_empleados`);
...
ALTER TABLE `ct_catalogo_universal`
  ...
  ADD KEY `FK_ct_catalogo_universal_ct_catalogo_universal` (`catalogo_universal`);

--
-- Indices de la tabla `empaquetamiento`
--
ALTER TABLE `empaquetamiento`
  ADD PRIMARY KEY (`Id_Empaque`),
  ADD KEY `FK_Empaquetamiento_ct_catalogo_universal` (`Tipo_Empaque`),
  ADD KEY `FK_Empaquetamiento_tb_empleados` (`Empleado_Empaque`),
  ADD KEY `FK_Empaquetamiento_tb_juguetes` (`Juguete_Empaque`);
...
ALTER TABLE `tb_empleados`
  ...
  ADD KEY `FK_tb_empleados_ct_catalogo_universal` (`Id_catalogos_universal`),
  ADD KEY `FK_tb_empleados_ct_catalogo_universal_02` (`cargo_empleados`);
...
ALTER TABLE `tb_juguetes`
  ...
  ADD KEY `FK_tb_juguetes_ct_catalogo_universal` (`color_jugete`),
  ADD KEY `FK_tb_juguetes_ct_catalogo_universal_02` (`tipo_producto`);
...
ALTER TABLE `tb_materiales`
  ...
  ADD KEY `FK_tb_materiales_ct_catalogo_universal` (`clase_material`),
  ADD KEY `FK_tb_materiales_ct_catalogo_universal_02` (`color_material`);
...
ALTER TABLE `th_produccion_juguetes`
  ...
  ADD KEY `FK_th_produccion_juguetes_tb_empleados` (`empleados_Produccion`),
  ADD KEY `FK_th_produccion_juguetes_tb_juguetes` (`juguetes_Produccion`);
...
ALTER TABLE `tp_materiales_juguetes`
  ...
  ADD KEY `FK_tp_materiales_juguetes_tb_juguetes` (`Id_juguetes`),
  ADD KEY `FK_tp_materiales_juguetes_tb_materiales` (`Id_material`);
...
--
-- Filtros para la tabla `empaquetamiento`
--
ALTER TABLE `empaquetamiento`
  ADD CONSTRAINT `FK_Empaquetamiento_ct_catalogo_universal` FOREIGN KEY (`Tipo_Empaque`) REFERENCES `ct_catalogo_universal` (`Id_catalogo_universal`),
  ADD CONSTRAINT `FK_Empaquetamiento_tb_empleados` FOREIGN KEY (`Empleado_Empaque`) REFERENCES `tb_empleados` (`Id_empleados`),
  ADD CONSTRAINT `FK_Empaquetamiento_tb_juguetes` FOREIGN KEY (`Juguete_Empaque`) REFERENCES `tb_juguetes` (`Id_juguetes`);
...
--
ALTER TABLE `th_produccion_juguetes`
  ADD CONSTRAINT `FK_th_produccion_juguetes_tb_empleados` FOREIGN KEY (`empleados_Produccion`) REFERENCES `tb_empleados` (`Id_empleados`),
  ADD CONSTRAINT `FK_th_produccion_juguetes_tb_juguetes` FOREIGN KEY (`juguetes_Produccion`) REFERENCES `tb_juguetes` (`Id_juguetes`);
