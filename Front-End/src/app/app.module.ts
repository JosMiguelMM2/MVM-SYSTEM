...
@NgModule({
  declarations: [AppComponent, MenuInicioComponent, ContactoComponent, EmpleadoComponent, CatalogoComponent, JuguetesComponent, MaterialesComponent, EmpaquetamientoComponent, ProduccionComponent, MaterialesJuguetesComponent, InformesComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
